...
# Get a base layer just to plot points
base.pts <- shapefile("data/gis/basemaps/ne_110m_land_no_oc.shp")
# Crop to the extent
base.pts <- buffer(base.pts, 0)
base.pts <- crop(base.pts, extent(po.pts))
base.pts <- as(base.pts, "SpatialLines")
base.pts <- crop(base.pts, extent(base.pts)-c(-0.5,0,0,0))
coordinates(base.pts)
base.pts <- st_as_sf(base.pts)
